  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless recruitment with HR Management Application. Track every stage of hiring - from initial rounds to the final decision, all tailored for IT Consulting firms."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless recruitment with HR Management Application. Track every stage of hiring - from initial rounds to the final decision, all tailored for IT Consulting firms.`}
            </Text>
            <Box
