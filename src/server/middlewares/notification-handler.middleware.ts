...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Job Application.create': {
    roles: ['owner', 'hr-manager', 'recruiter'],
    key: 'job_application',
    tenantPath: [],
    userPath: [],
  },
  'Interview Scheduled.create': {
    roles: ['owner', 'hr-manager', 'recruiter', 'interviewer'],
    key: 'interview_schedule',
    tenantPath: [],
    userPath: [],
  },
  'Candidate Status Updated.update': {
    roles: ['owner', 'hr-manager', 'recruiter'],
...
const tenantRoles: string[] = ['owner', 'hr-manager', 'recruiter', 'interviewer'];
